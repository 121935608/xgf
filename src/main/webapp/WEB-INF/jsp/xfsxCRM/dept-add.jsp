...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-dept-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-6">
				<textarea name="describe" cols="" rows="" class="textarea"  placeholder="" datatype="*0-100" dragonfly="true" onKeyUp="textarealength(this,200)"></textarea>
