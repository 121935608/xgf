...
<div class="page-container">
    <div class="text-c">
        <input id="supervisorId" name="" value="${store['supervisorId']}" style="display: none;">
        <input id="storeId" name="" value="${store['storeId']}" style="display: none;">
...
<div style="margin-top: 20px;margin-left:300px;">
    <div class="btn btn-primary" id="save" state="${store['storeId']}">提交</div>
</div>
    ...
    $(function(){
        $("#save").click(function(){
            ...
            if(supervisorId != undefined && supervisorId != null){
                $.ajax({
                    url:"${context_url}/crmStore/crmUpdateStoreSupervistor.action",
                    data:{'storeId':storeId, 'supervisorId':supervisorId},
                    type:'post',
                    async:true ,
                    cache:false ,
                    dataType:"json",
