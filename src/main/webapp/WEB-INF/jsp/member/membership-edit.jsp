	...
	<form action="" method="post" class="form form-horizontal" id="form-member-edit">
		<div class="row cl">
			<div class="formControls col-xs-8 col-sm-4">
				<input type="hidden" class="input-text" value="${membership.memberId}" placeholder="" id="memberId" name="memberId">
			</div>
		</div>
		<div class="row cl">
			<div class="formControls col-xs-8 col-sm-4">
				<input type="hidden" class="input-text" value="${membership.storeId}" placeholder="" id="storeId" name="storeId">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>会员号：</label>
			<div class="formControls col-xs-8 col-sm-4">
				<input type="text" class="input-text" value="${membership.memberNo}" placeholder="" name="memberNo" id="memberNo">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-4">
				<input type="text" class="input-text" value="${membership.timeLimit}" placeholder="" id="timeLimit" name="timeLimit">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>会员积分：</label>
			<div class="formControls col-xs-8 col-sm-4">
				<input type="text" class="input-text" value="${membership.score}" placeholder="" id="score" name="score">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-4">
				<span class="select-box" style="width: 120px;">
				   <select name="level" id="level" class="select" autocomplete="off">
					   ...
					   <option value="A" ${membership.level=="A"?"selected='selected'":''}>A</option>
					   <option value="B" ${membership.level=="B"?"selected='selected'":''}>B</option>
					   <option value="C" ${membership.level=="C"?"selected='selected'":''}>C</option>
					   <option value="D" ${membership.level=="D"?"selected='selected'":''}>D</option>
					   <option value="E" ${membership.level=="E"?"selected='selected'":''}>E</option>
				   </select>
				</span>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-4">
				<input type="text" class="input-text" value="${membership.qq}" placeholder="" id="qq" name="qq">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>邮箱：</label>
			<div class="formControls col-xs-8 col-sm-4">
				<input type="email" class="input-text" value="${membership.email}" placeholder="@" id="email" name="email">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>住址：</label>
			<div class="formControls col-xs-8 col-sm-4">
				<input type="text" class="input-text" value="${membership.address}" placeholder="" id="address" name="address">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">备注：</label>
			<div class="formControls col-xs-8 col-sm-6">
				<textarea name="remark" cols="" rows="" class="textarea"  placeholder="" datatype="*10-100" dragonfly="true" onKeyUp="textarealength(this,200)">${membership.remark}</textarea>
