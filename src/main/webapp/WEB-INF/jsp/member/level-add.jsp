...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-level-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-4">
				<input type="number" class="input-text" autocomplete="off" value="" placeholder="" name="discount" id="discount">
			</div>
		</div>
		<div class="row cl">
