...
<article class="page-container">
	<form action="" method="post"  class="form form-horizontal" id="form-commodityAd-add">
...
$("#form-commodityAd-add").validate({
	...
	submitHandler:function(form){
		...
		var formData = new FormData($('#form-commodityAd-add')[0]);
		$.ajax({
