...
<ys:contentHeader title="商品销售登记表"/>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 数据统计 <span class="c-gray en">&gt;</span> 商品销售登记表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="text-c">
		...
		<input type="text" class="input-text" style="width:250px" placeholder="商品名称|商品编号|订单号" id="commodityName" name="commodityName">
...
$(document).ready(function(){ 
    ...
    var url = "${context_root}/dataCount/findSaleInfo.action";
