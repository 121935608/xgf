...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 虚拟订单管理 <span class="c-gray en">&gt;</span> 订单管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
//                row.platform;
        ...
        },
        {
            ...
            "mRender": function(data, type, row) {
                //查看
                var tolook = "<a title=\"查看\" href=\"javascript:;\" onclick=\"order_look('查看','${context_root}/virtualOrder/toLookOrderInfo.action?orderNumber=" + row.orderNumber + "','','510')\" class=\"ml-5\" style=\"text-decoration:none\"><span style='color: #0e90d2 '>查看</span></a>";
                //打印配送单
                var toPrint = "<a title=\"打印配送单\" href=\"javascript:;\" onclick=\"order_print('打印配送单','${context_root}/virtualOrder/toPrintOrder.action?orderNumber=" + row.orderNumber + "','230','406')\" class=\"ml-5\" style=\"text-decoration:none\"><span style='color: #0e90d2 '>打印配送单</span></a>";
                var toEdit=""
    ...
    var url = "${context_root}/virtualOrder/findOrderManageList.action";
