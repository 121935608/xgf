...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 订单管理 <span class="c-gray en">&gt;</span>
    虚拟订单管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
...
//                row.platform;
    ...
    function order_confirmOrder(orderNumber) {
        parent.layer.confirm('是否确认出库？', {icon: 3, title: '确认后将推送库存'}, function (index) {
            $.ajax({
                url: "${context_root}/virtualOrder/confirmOrder.action?orderNumber=" + orderNumber,
                type: 'post',
                async: true,
                cache: false,
                dataType: "json",
