...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 商品管理 <span class="c-gray en">&gt;</span>
    <span id="cons">商品列表 </span> <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
...
<div class="page-container">
    ...
    <div class="text-c">
        ...
        <input type="text" class="input-text" style="width:250px" placeholder="编号|商品名称|商品条码" id="commodityName"
               name="commodityName">
            ...
            },
            {
                ...
                "mRender": function (data, type, row) {
                    if (row.commodityStatus == "0") {
                        ...
                        return "<span class=\"label label-defaunt radius\">下架</span>";
                    }
                }
            },
            {
