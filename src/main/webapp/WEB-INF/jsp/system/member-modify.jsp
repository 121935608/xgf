...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-user-modify">
		<input type="hidden" class="input-text" id="userId" name="id" value="${member.id }">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-4">
				<input type="text" class="input-text" placeholder="" id="accountName" name="phone" value="${member.phone }">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>验证码：</label>
			<div class="formControls col-xs-8 col-sm-4">
				<input type="text" class="input-text" placeholder="@" id="email" name="phoneCode" value="${member.phoneCode }">
			</div>
		</div>
		<%--<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>手机号码：</label>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-7 col-sm-4 skin-minimal">
				<y:radio codeGroup="sys-locked" name="codeStrus" selectedValue="${member.codeStrus }"/>
			</div>
		</div>
