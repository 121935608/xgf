        ...
        <div class="info-div" style="margin: auto;margin-top:50px;z-index: 1">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <textarea name="remark" cols="" rows="" class="textarea" placeholder="一般来说是写拒绝原因" datatype="*10-100"
                              dragonfly="true" onKeyUp="textarealength(this,200)">${store.remark}</textarea>
                </div>
            </div>
            <div class="row cl">
