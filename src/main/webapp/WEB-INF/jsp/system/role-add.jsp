	...
	<form action="" method="post" class="form form-horizontal" id="form-role-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-7 col-sm-4 skin-minimal">
				<y:radio codeGroup="sys-role_status" name="status" selectedValue="0"/>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">描述：</label>
			<div class="formControls col-xs-8 col-sm-6">
				<textarea name="description" cols="" rows="" class="textarea"  placeholder="说点什么..." datatype="*10-100" dragonfly="true" onKeyUp="textarealength(this,200)"></textarea>
...
$("#form-role-add").validate({
	...
	submitHandler:function(form){
		...
		$.ajax({
			url:"${context_root}/system/saveRole.action", 
			type:'post',
			async:true ,
			cache:false ,
			data:$(form).serialize(),
