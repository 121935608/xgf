...
public class ExecutorPageMethodInterceptor implements Interceptor
{
            ...
            { // 拦截需要分页的SQL
                ...
                else
                {
                    ...
                    { // 参数为某个实体，该实体拥有Page属性
                        ...
                        if (pageField != null)
                        {
                            pageUtilEntity = (PageUtilEntity) ReflectHelper.getValueByFieldName(parameterObject,
                                    "page");
    ...
    {
        if (pageUtilEntity != null && ObjectUtil.isNotEmpty(dialect))
        {
    ...
    public void setProperties(Properties p)
    {
        ...
        if (ObjectUtil.isEmpty(pageSqlId))
        {
            try
            {
